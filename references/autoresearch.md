...
This reference adapts Andrej Karpathy's autoresearch methodology (autonomous experimentation loops) to Claude Code skills. Instead of optimizing ML training code, we optimize skill prompts.
...
**Open it immediately** after creating it so the user can see it in their browser.
