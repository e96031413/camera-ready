...
## Optional add-ons
- Source grading / predatory screening: `references/source-quality-hierarchy.md`
- PRISMA-lite systematic review workflow: `references/systematic-review-addon.md`
- Role-based (framework-agnostic) research personas: `references/agentic-workflow.md`
