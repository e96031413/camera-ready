...
> Committed example output. The absolute paths this script normally prints
> have been replaced with `<paper_dir>`; everything else is verbatim.

- Project: `<paper_dir>`
- Tarball: `<paper_dir>\submission.tar.gz`
- Files packaged: 2
- Blocking problems: 0
- Warnings: 0
...
- Inlined main.bbl (3578 chars) in place of \bibliography{...}
